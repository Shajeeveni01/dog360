  ...
  return (
    <div className="min-h-screen bg-rose-50 flex flex-col items-center py-10">
      ...
      <div className="bg-white p-6 rounded-lg shadow-md w-full max-w-md mb-6">
        ...
        <input type="file" accept=".jpg,.png,.pdf" className="w-full mt-2" onChange={handleFileChange} />
        <select
        ...
        <button onClick={handleUpload} className="w-full bg-rose-500 hover:bg-rose-600 text-white py-2 rounded-lg mt-3 transition">
          Upload Record
        </button>
      </div>
                  ...
                  {records
                    ...
                    .map((record) => (
                      <li key={record.id} className="flex justify-between items-center mb-2">
                        ...
                        <button onClick={() => handleDelete(record)} className="bg-red-500 text-white px-3 py-1 rounded-md">
                          Delete
                        </button>
                      </li>
                    ))}
